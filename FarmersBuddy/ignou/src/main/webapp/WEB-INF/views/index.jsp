...
<script src="ABC/script.js" language="javascript"></script>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td bgcolor="#336600"><img src="ABC/corn-bot1.gif" width="50" height="18"><img src="ABC/sanjeev.gif" width="34" height="18"><img src="ABC/grad.gif" width="332" height="18"><jsp:include page="adminoptions.html"/></td>
      </tr>
    </tbody></table>
      <table><tr><td>
    ...
    <html:form action="/soil">
		
		
		<table cellspacing=2 align="center">
				<tr><td><b>SoilName</b></td><td> <html:text property="soilname"/></td><td><html:errors property="soilname"/></td></tr>
